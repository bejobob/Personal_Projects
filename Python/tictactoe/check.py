...
v.1.1(09/25/25) Removed board as a global variable and put it directly in tictactoe.py. Made it a check_for_win_or_potential of the function to avoid circular imports
"""

danger = ['row', 'number'] # this list contains the information needed to block a win

def check_for_win_or_potential(board, bots_shape): # this function checks the board for wins or two-in-a-rows
